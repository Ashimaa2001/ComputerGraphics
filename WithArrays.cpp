...
float balloon_X[2]= {-800.0, 0.0};
float balloon_Y[2]={0.0, -600.0};
float balloonRadius[2]={40.0, 40.0};
float balloonSpeedX[2]= {0.5,0.5};
float balloonSpeedY[2]= {0.5, 0.5};
...
void checkLaser(int x, int y, int x1, int y1,int x2, int y2){
    if(balloonRadius[0]<20.0 && balloonRadius[1]<20.0){
...
void gameStartDisplay()
{
    ...
    if(laser) {
        DrawLaser(xOne, yOne);
        checkLaser(xOne, yOne, balloon_X[0], balloon_Y[0], balloon_X[1], balloon_Y[1]);
    }
}
